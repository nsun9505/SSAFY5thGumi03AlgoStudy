...
크루스칼 알고리즘을 활용해 문제를 풀어줬습니다.

우주선들의 좌표를 받은 뒤 연결된 통로들은 union연산을 통해 합쳐줍니다.

그뒤 입력받은 좌표들의 거리를 모두 spacelist에 넣어주고 크루스칼 연산을 통해 연결되지 않은 것들을 연결해준 뒤 weight 를 누적해서 출력해주면 됩니다.
